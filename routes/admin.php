...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/seller/{id}/guarantee_money',  'showAddFundForm')->name('sellers.guarantee_money');
        Route::post('/seller/{id}/guarantee_money',  'storeFund')->name('sellers.guarantee_money');
        ...
        Route::get('/sellers/add/funds/{encrypted_id}', 'add_funds')->name('sellers.add_funds');
        Route::post('/sellers/add-funds', 'add_funds_store')->name('sellers.add_funds.store');
        Route::get('/sellers/views/edit/{id}', 'editViews')->name('sellers.views.edit');
        Route::post('/sellers/views/update', 'updateViews')->name('sellers.views.update');

        Route::post('/sellers/subtract-funds',  'subtract_funds')->name('sellers.subtract_funds.store');
...
Route::post('/get-cities',  'getCities')->name('get-cities');
        Route::get('/{id}/manual-order', 'manualOrderCreate')->name('manual_order.create');
        Route::post('/{id}/manual-order',  'manualOrderStore')->name('manual_order.store');
