<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3" style="background-color: #232734">
                ...
                @endif
                <h3 class="fs-16  m-0 text-primary" style="color:#fff !important;">{{ optional(Auth::user()->shop)->name }}</h3>
                <p class="text-primary" style="color:#fff !important;">{{ Auth::user()->email }}</p>
            </div>
        </div>
        <div class="aiz-side-nav-wrap">
            <div class="px-20px mb-3">
                <input class="form-control bg-soft-secondary border-0 form-control-sm" type="text" name=""
                    placeholder="{{ translate('Search') }}" id="menu-search" autocomplete="off" onkeyup="menuSearch()">
            </div>
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->shop && Auth::user()->shop->verification_status)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('seller.products.warehouse') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['seller.products.warehouse']) }}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    class="aiz-side-nav-link {{ areActiveRoutes(['seller.orders.index', 'seller.orders.show']) }}">
                        ...
                        <span class="aiz-side-nav-text d-flex justify-content-between">
                            {{ translate('Orders') }}
                                <span class="badge badge-danger ml-2">{{ $unpaid_orders_count }}</span>
                        </span>
                    </a>
                </li>
